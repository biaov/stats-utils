...
const transformData = (data) => {
  const document2 = parseFromString(data);
  const [rewardBox] = document2.getElementsByClassName("personal-reward-box");
  ...
  const [tagBox] = document2.getElementsByClassName("personal-tag-box");
